...
class FrontEnd {
  ...
  public:
    ...
    bool Update(const CloudData& cloud_data, Eigen::Matrix4f& cloud_pose,const Eigen::Matrix4f& predict_pose);
    bool SetInitPose(const Eigen::Matrix4f& init_pose);
    bool SetGNSSInitPose(const Eigen::Matrix4f& init_pose) ;
